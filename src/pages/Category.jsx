...
function Category() {
  ...
  return (
    ...
    {_id && loading ?
        <Loader />
        :
        <div className='rounded-xl py-6 bg-white flex-1 flex flex-col gap-5 sm:gap-2 sm:pb-10 sm:rounded-lg sm:bg-white sm:p-0 sm:py-6 sm:w-full w-1/2 shadow-sm'>
            <h2 className='text-themeBlack-300 text-lg font-bold px-10 mb-0 sm:px-6'>{_id? t('editCategory') : t('createCategory')}</h2>
